...
const featuredCourses = [
  {
    ...
    description: 'Master complex mathematical concepts with clear, structured lessons.',
    targetGrades: ['Grade 11', 'Grade 12'],
  },
  {
    title: 'Scientific Thinking',
    description: 'Develop critical thinking skills through scientific methodology.',
    targetGrades: ['University - Year 1', 'University - Year 2'],
  },
  {
    title: 'Digital Literacy',
    description: 'Navigate the digital world with confidence and understanding.',
    targetGrades: ['Professional Development'],
  },
  {
    title: 'Creative Problem Solving',
    description: 'Unlock innovative approaches to complex challenges.',
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="font-poppins text-4xl lg:text-6xl font-bold text-[#212121] mb-6">
                Abstract Learning for a{' '}
                <span className="text-[#008080]">Clearer Mind</span>
              </h1>
              <p className="text-lg lg:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Experience education through minimalist design and focused learning. 
                Our platform strips away distractions to help you concentrate on what matters most.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/signup">
                  <Button 
                    className="bg-[#008080] hover:bg-[#006666] text-white px-8 py-6 text-lg rounded-lg"
                    size="lg"
                  >
                ...
                <Link href="/courses">
                  <Button 
                    variant="outline" 
                    className="border-[#008080] text-[#008080] hover:bg-[#008080] hover:text-white px-8 py-6 text-lg rounded-lg"
                    size="lg"
                  >
                    Explore Courses
                  </Button>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {featuredCourses.map((course, index) => (
                <Card key={index} className="border-gray-100 hover:border-[#008080] transition-colors duration-300 shadow-sm hover:shadow-md">
                  <CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {steps.map((step, index) => (
                <div key={index} className="text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-[#008080] text-white rounded-full font-poppins font-bold text-xl mb-6">
                    {step.number}
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-8 text-sm text-gray-600">
                <Link href="/about" className="hover:text-[#008080] transition-colors">
                  About
                </Link>
                <Link href="/privacy" className="hover:text-[#008080] transition-colors">
                  Privacy Policy
                </Link>
                <Link href="/contact" className="hover:text-[#008080] transition-colors">
                  Contact
                </Link>
              </div>
              <p className="text-sm text-gray-500 mt-4">
                © 2024 Abstract Learning. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
