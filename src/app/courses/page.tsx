      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Explore our comprehensive collection of courses designed for different learning levels and interests.
          </p>
        </div>
        ...
        {filteredCourses.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredCourses.map((course) => (
              <Card 
                key={course._id} 
                className="border-gray-100 hover:border-[#008080] transition-all duration-300 shadow-sm hover:shadow-lg group"
              >
                <CardHeader>
                  <div className="flex justify-between items-start mb-2">
                    <CardTitle className="font-poppins text-xl text-[#212121] group-hover:text-[#008080] transition-colors">
                      {course.title}
                    </CardTitle>
        ...
        <div className="mt-16 text-center bg-white rounded-lg p-8 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/signup">
              <Button 
                className="bg-[#008080] hover:bg-[#006666] text-white px-8 py-3"
                size="lg"
              >
                Get Started
              </Button>
            ...
            <Link href="/about">
              <Button 
                variant="outline"
                className="border-[#008080] text-[#008080] hover:bg-[#008080] hover:text-white px-8 py-3"
                size="lg"
              >
                Learn More
              </Button>
