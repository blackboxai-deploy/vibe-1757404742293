            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="mt-1 border-gray-200 focus:border-[#008080] focus:ring-[#008080] min-h-[120px]"
      ...
      <div className="space-y-4">
        {announcements.length === 0 ? (
          ...
          announcements.map((announcement) => (
            <Card key={announcement._id} className="border-gray-100 hover:border-[#008080] transition-colors duration-300">
              <CardHeader>
                ...
                {announcement.link && (
                  <div className="mb-4">
                    <a
                      ...
                      className="text-[#008080] hover:text-[#006666] underline text-sm"
                    >
                      {announcement.link}
                    </a>
                  </div>
