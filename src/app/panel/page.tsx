  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="border-gray-200 hover:border-[#008080] transition-colors duration-300">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <a
                ...
                className="block p-3 bg-gray-50 rounded-lg hover:bg-[#008080] hover:bg-opacity-10 transition-colors duration-200"
              >
