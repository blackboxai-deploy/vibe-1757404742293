            ...
            {enrolledCourses.length === 0 ? (
              ...
              <div className="space-y-4">
                {enrolledCourses.map((course) => (
                  <Card key={course._id} className="border-gray-100 hover:border-[#008080] transition-colors duration-300 shadow-sm hover:shadow-md">
                    <CardHeader>
                    ...
                    <CardContent className="pt-0">
                      ...
                      {announcement.link && (
                        <a 
                          ...
                          className="text-xs text-[#008080] hover:text-[#006666] underline"
                        >
                          View Link
                        </a>
                      )}
