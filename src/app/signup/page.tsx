        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <Input
                ...
                className="mt-1 border-gray-200 focus:border-[#008080] focus:ring-[#008080]"
            ...
            <div>
              ...
              <Select
                ...
                disabled={loading}
              >
                <SelectTrigger className="mt-1 border-gray-200 focus:border-[#008080] focus:ring-[#008080]">
            ...
            <Button
              type="submit"
              className="w-full bg-[#008080] hover:bg-[#006666] text-white py-3 font-medium"
              disabled={loading}
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="text-[#008080] hover:text-[#006666] font-medium">
                Sign in
              </Link>
            </p>
          </div>
